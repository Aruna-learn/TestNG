...
public class OpenCartParameters {
	...
	//@Parameters("sleep")
	//@AfterTest
	//public void closebrowser(String sleep) throws NumberFormatException, InterruptedException {
	//	System.out.println(sleep);
	//	Thread.sleep(Long.valueOf(sleep));we can use String or long
